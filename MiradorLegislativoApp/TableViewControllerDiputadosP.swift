//
//  TableViewControllerDiputadosP.swift
...
class TableViewControllerDiputadosP: UITableViewController, UISearchBarDelegate, UISearchDisplayDelegate  {
    ...
    func filterContentForSearchText(searchText: String, scope: String = "All") {
        self.arrayOfXmlProponenteResuls = self.arrayOfXmlProponente.filter({( diputado : XmlProponentes) -> Bool in
            ...
            var stringMatch = diputado.diputado_nombre.lowercaseString.rangeOfString(searchText.lowercaseString)
