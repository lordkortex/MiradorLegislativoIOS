...
struct Variables {
    ...
    static var  arrayOfXmlSesionesName = "arrayOfXmlSesiones"
    static var  arrayOfXmlComisionesName = "arrayOfXmlComisiones"
    
    static var  arrayOfXmlComisionesDistinctName = "arrayOfXmlComisionesDistinct"
    static var  arrayOfXmlDebatesName = "arrayOfXmlDebates"
    static var  arrayOfXmlIntervencionesName = "arrayOfXmlIntervenciones"
    static var  arrayOfXmlIntervencionesPorUsuarioName = "arrayOfXmlIntervencionesPorUsuario"
    static var  arrayOfXmlPartidosName = "arrayOfXmlPartidos"
    static var  arrayOfXmlProponentesName = "arrayOfXmlProponentes"
    static var  arrayOfXmlProponentesPorComisionName = "arrayOfXmlProponentesPorComision"
    static var  arrayOfXmlProyectosName = "arrayOfXmlProyectos"
